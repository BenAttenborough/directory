// elm-watch hot {"version":"1.1.1","targetName":"My target name","webSocketPort":57313}
"use strict";
(() => {
...
var $author$project$Directory$Directory = F2(
...
var $author$project$Directory$singleton = function (directory) {
...
var $author$project$Directory$File = F2(
	function (label, size) {
...
var $author$project$Directory$addFiles = F2(
...
var $author$project$Directory$addFile = F2(
	function (file, directory) {
		return A2(
			$author$project$Directory$addFiles,
			_List_fromArray(
				[file]),
			directory);
	});
var $author$project$Directory$childLabelConflictsWithExisting = F2(
...
var $author$project$Directory$addFolderInternal = F2(
	function (child, parent) {
		...
		if (!_v0.b) {
			...
			var children = _v0;
			return A2($author$project$Directory$childLabelConflictsWithExisting, child, children) ? parent : A2($zwilias$elm_rosetree$Tree$prependChild, child, parent);
		}
	});
...
var $author$project$Directory$addFolderCommand = F2(
	function (folder, parent) {
		return A2(
			$author$project$Directory$childLabelConflictsWithExisting,
			...
			A2(
				$zwilias$elm_rosetree$Tree$Zipper$mapTree,
				$author$project$Directory$addFolderInternal(
					A2($zwilias$elm_rosetree$Tree$tree, folder, _List_Nil)),
				parent));
	});
...
var $author$project$Directory$changeDirectoryCommand = F2(
...
var $author$project$DirectoryParser$CD = function (a) {
	return {$: 'CD', a: a};
};
var $author$project$DirectoryParser$Clear = {$: 'Clear'};
var $author$project$DirectoryParser$LS = {$: 'LS'};
var $author$project$DirectoryParser$MakeDir = function (a) {
	return {$: 'MakeDir', a: a};
};
var $author$project$DirectoryParser$Pwd = {$: 'Pwd'};
var $author$project$DirectoryParser$Touch = F2(
	function (a, b) {
...
var $author$project$DirectoryParser$dirWord = $elm$parser$Parser$getChompedString(
	A2(
...
var $author$project$DirectoryParser$word = $elm$parser$Parser$getChompedString(
	A2(
		$elm$parser$Parser$ignorer,
		A2(
			$elm$parser$Parser$ignorer,
...
var $author$project$DirectoryParser$commandParser = A2(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$DirectoryParser$CD),
						$elm$parser$Parser$keyword('cd')),
					$elm$parser$Parser$spaces),
				$author$project$DirectoryParser$dirWord),
				A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$DirectoryParser$LS),
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$DirectoryParser$MakeDir),
						$elm$parser$Parser$keyword('mkdir')),
					$elm$parser$Parser$spaces),
				$author$project$DirectoryParser$word),
				A2(
				$elm$parser$Parser$keeper,
				A2(
					$elm$parser$Parser$keeper,
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$DirectoryParser$Touch),
							$elm$parser$Parser$keyword('touch')),
						$elm$parser$Parser$spaces),
					A2($elm$parser$Parser$ignorer, $author$project$DirectoryParser$word, $elm$parser$Parser$spaces)),
				$elm$parser$Parser$int),
				A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$DirectoryParser$Clear),
...
var $author$project$Directory$getLabelFromZipper = function (dir) {
...
var $author$project$Directory$listDir = function (directory) {
	var directories = A2(
		$elm$core$List$map,
		function (dir) {
...
var $author$project$DirectoryParser$update = F2(
	function (msg, model) {
		if (msg.$ === 'OnChange') {
			...
			var key = msg.a;
			if (key === 13) {
				var parserResult = A2($elm$parser$Parser$run, $author$project$DirectoryParser$commandParser, model.terminalInput);
				if (parserResult.$ === 'Ok') {
					...
					switch (command.$) {
						...
						case 'MakeDir':
							var name = command.a;
							var _v4 = A2(
								$author$project$Directory$addFolderCommand,
								A2($author$project$Directory$Directory, name, _List_Nil),
								model.directoryTree);
							if (_v4.$ === 'Ok') {
								var val = _v4.a;
								return A3(
...
var $author$project$DirectoryParser$OnChange = function (a) {
	return {$: 'OnChange', a: a};
};
var $author$project$DirectoryParser$OnKeyDown = function (a) {
...
var $author$project$DirectoryParser$onKeyDown = function (tagger) {
	return A2(
...
var $author$project$Directory$toListItems = F2(
...
var $author$project$Directory$toHtml = function (dir) {
	return function (root) {
		...
		A3(
			...
			$author$project$Directory$directoryToHtml,
			$author$project$Directory$toListItems,
			$zwilias$elm_rosetree$Tree$Zipper$toTree(dir)));
};
var $elm$html$Html$Attributes$value = $elm$html$Html$Attributes$stringProperty('value');
var $author$project$DirectoryParser$view = function (_v0) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Directory$toHtml(directoryTree)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
...
var $author$project$DirectoryParser$main = $elm$browser$Browser$sandbox(
	{init: $author$project$DirectoryParser$initialModel, update: $author$project$DirectoryParser$update, view: $author$project$DirectoryParser$view});
_Platform_export({'DirectoryParser':{'init':$author$project$DirectoryParser$main(
